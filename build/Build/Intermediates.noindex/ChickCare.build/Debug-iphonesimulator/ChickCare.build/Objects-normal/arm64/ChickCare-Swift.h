...
#ifndef CHICKCARE_SWIFT_H
#define CHICKCARE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ChickCare",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9ChickCare11AppDelegate")
@interface AppDelegate : UIResponder <AppsFlyerLibDelegate, AppsFlyerDeepLinkDelegate, FIRMessagingDelegate, UIApplicationDelegate, UNUserNotificationCenterDelegate>
...
@class WKNavigation;
SWIFT_CLASS("_TtC9ChickCare22BrowserDelegateManager")
@interface BrowserDelegateManager : NSObject <WKNavigationDelegate, WKUIDelegate>
...
@interface BrowserDelegateManager (SWIFT_EXTENSION(ChickCare))
- (void)handleEdgePan:(UIScreenEdgePanGestureRecognizer * _Nonnull)recognizer;
@end
